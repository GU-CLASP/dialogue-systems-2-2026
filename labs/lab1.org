...
See in the [[file:~/Teaching/ds-2/dialogue-systems-2-2026/tutorials/rag.org][RAG tutorial]].  There is also a ~/rag/docker-compose.yml~ file
that you can use.
...
- VG-RAG :: *Further experiments with RAG*. Provide a short report (~2
  A4 page; PDF, Markdown or org-mode
format), covering your reflections and "proof-of-concept" tests. Here
  is /a tentative list of questions/ to reflect on or try to
  implement. 
  ...
  - Can you implement filtering and re-ranking for query results?
    ...
    There is no requirement of the number of questions needed
  for completion of VG part, because you can go quite deep with
  addressing just one of them. Think about your project while working
  on these questions and don't forget to consult [[https://qdrant.tech/documentation/][Qdrant documentation]]. Commit the report in ~/labs/lab1~ folder.
